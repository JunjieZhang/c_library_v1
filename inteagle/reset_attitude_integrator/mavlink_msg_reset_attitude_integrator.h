...
#define MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR_MIN_LEN 8
#define MAVLINK_MSG_ID_154_LEN 8
#define MAVLINK_MSG_ID_154_MIN_LEN 8
                               ...
                               uint64_t timestamp)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR_MIN_LEN, MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR_LEN, MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR_CRC);
}
                                   ...
                                   uint64_t timestamp)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR_MIN_LEN, MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR_LEN, MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR_CRC);
}
...
static inline void mavlink_msg_reset_attitude_integrator_send(mavlink_channel_t chan, uint64_t timestamp)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR, buf, MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR_MIN_LEN, MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR_LEN, MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR_CRC);
#else
    mavlink_reset_attitude_integrator_t packet;
    packet.timestamp = timestamp;

    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR, (const char *)&packet, MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR_MIN_LEN, MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR_LEN, MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_reset_attitude_integrator_send_struct(mavlink_channel_t chan, const mavlink_reset_attitude_integrator_t* reset_attitude_integrator)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_reset_attitude_integrator_send(chan, reset_attitude_integrator->timestamp);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR, (const char *)reset_attitude_integrator, MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR_MIN_LEN, MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR_LEN, MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR_LEN? msg->len : MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR_LEN;
        memset(reset_attitude_integrator, 0, MAVLINK_MSG_ID_RESET_ATTITUDE_INTEGRATOR_LEN);
    memcpy(reset_attitude_integrator, _MAV_PAYLOAD(msg), len);
#endif
}
