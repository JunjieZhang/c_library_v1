...
#define MAVLINK_MSG_ID_PX4_TIMESYNC_MIN_LEN 16
#define MAVLINK_MSG_ID_160_LEN 16
#define MAVLINK_MSG_ID_160_MIN_LEN 16
                               ...
                               uint64_t timestamp, int64_t sync_id)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_PX4_TIMESYNC_MIN_LEN, MAVLINK_MSG_ID_PX4_TIMESYNC_LEN, MAVLINK_MSG_ID_PX4_TIMESYNC_CRC);
}
                                   ...
                                   uint64_t timestamp,int64_t sync_id)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_PX4_TIMESYNC;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_PX4_TIMESYNC_MIN_LEN, MAVLINK_MSG_ID_PX4_TIMESYNC_LEN, MAVLINK_MSG_ID_PX4_TIMESYNC_CRC);
}
...
static inline void mavlink_msg_px4_timesync_send(mavlink_channel_t chan, uint64_t timestamp, int64_t sync_id)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PX4_TIMESYNC, buf, MAVLINK_MSG_ID_PX4_TIMESYNC_MIN_LEN, MAVLINK_MSG_ID_PX4_TIMESYNC_LEN, MAVLINK_MSG_ID_PX4_TIMESYNC_CRC);
#else
    mavlink_px4_timesync_t packet;
    packet.timestamp = timestamp;
    packet.sync_id = sync_id;

    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PX4_TIMESYNC, (const char *)&packet, MAVLINK_MSG_ID_PX4_TIMESYNC_MIN_LEN, MAVLINK_MSG_ID_PX4_TIMESYNC_LEN, MAVLINK_MSG_ID_PX4_TIMESYNC_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_px4_timesync_send_struct(mavlink_channel_t chan, const mavlink_px4_timesync_t* px4_timesync)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_px4_timesync_send(chan, px4_timesync->timestamp, px4_timesync->sync_id);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PX4_TIMESYNC, (const char *)px4_timesync, MAVLINK_MSG_ID_PX4_TIMESYNC_MIN_LEN, MAVLINK_MSG_ID_PX4_TIMESYNC_LEN, MAVLINK_MSG_ID_PX4_TIMESYNC_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_PX4_TIMESYNC_LEN? msg->len : MAVLINK_MSG_ID_PX4_TIMESYNC_LEN;
        memset(px4_timesync, 0, MAVLINK_MSG_ID_PX4_TIMESYNC_LEN);
    memcpy(px4_timesync, _MAV_PAYLOAD(msg), len);
#endif
}
