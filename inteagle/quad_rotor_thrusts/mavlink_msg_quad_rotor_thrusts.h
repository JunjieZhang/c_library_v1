...
#define MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS_MIN_LEN 24
#define MAVLINK_MSG_ID_151_LEN 24
#define MAVLINK_MSG_ID_151_MIN_LEN 24
                               ...
                               uint64_t timestamp, float thrust_1, float thrust_2, float thrust_3, float thrust_4)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS_MIN_LEN, MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS_LEN, MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS_CRC);
}
                                   ...
                                   uint64_t timestamp,float thrust_1,float thrust_2,float thrust_3,float thrust_4)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS_MIN_LEN, MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS_LEN, MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS_CRC);
}
...
static inline void mavlink_msg_quad_rotor_thrusts_send(mavlink_channel_t chan, uint64_t timestamp, float thrust_1, float thrust_2, float thrust_3, float thrust_4)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS, buf, MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS_MIN_LEN, MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS_LEN, MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS_CRC);
#else
    mavlink_quad_rotor_thrusts_t packet;
    packet.timestamp = timestamp;
    packet.thrust_1 = thrust_1;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS, (const char *)&packet, MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS_MIN_LEN, MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS_LEN, MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_quad_rotor_thrusts_send_struct(mavlink_channel_t chan, const mavlink_quad_rotor_thrusts_t* quad_rotor_thrusts)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_quad_rotor_thrusts_send(chan, quad_rotor_thrusts->timestamp, quad_rotor_thrusts->thrust_1, quad_rotor_thrusts->thrust_2, quad_rotor_thrusts->thrust_3, quad_rotor_thrusts->thrust_4);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS, (const char *)quad_rotor_thrusts, MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS_MIN_LEN, MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS_LEN, MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS_LEN? msg->len : MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS_LEN;
        memset(quad_rotor_thrusts, 0, MAVLINK_MSG_ID_QUAD_ROTOR_THRUSTS_LEN);
    memcpy(quad_rotor_thrusts, _MAV_PAYLOAD(msg), len);
#endif
}
