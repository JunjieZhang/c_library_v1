...
#define MAVLINK_MSG_ID_MAGNETIC_FIELD_MIN_LEN 20
#define MAVLINK_MSG_ID_152_LEN 20
#define MAVLINK_MSG_ID_152_MIN_LEN 20
                               ...
                               uint64_t timestamp, float mag_x, float mag_y, float mag_z)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_MAGNETIC_FIELD_MIN_LEN, MAVLINK_MSG_ID_MAGNETIC_FIELD_LEN, MAVLINK_MSG_ID_MAGNETIC_FIELD_CRC);
}
                                   ...
                                   uint64_t timestamp,float mag_x,float mag_y,float mag_z)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_MAGNETIC_FIELD;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_MAGNETIC_FIELD_MIN_LEN, MAVLINK_MSG_ID_MAGNETIC_FIELD_LEN, MAVLINK_MSG_ID_MAGNETIC_FIELD_CRC);
}
...
static inline void mavlink_msg_magnetic_field_send(mavlink_channel_t chan, uint64_t timestamp, float mag_x, float mag_y, float mag_z)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MAGNETIC_FIELD, buf, MAVLINK_MSG_ID_MAGNETIC_FIELD_MIN_LEN, MAVLINK_MSG_ID_MAGNETIC_FIELD_LEN, MAVLINK_MSG_ID_MAGNETIC_FIELD_CRC);
#else
    mavlink_magnetic_field_t packet;
    packet.timestamp = timestamp;
    packet.mag_x = mag_x;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MAGNETIC_FIELD, (const char *)&packet, MAVLINK_MSG_ID_MAGNETIC_FIELD_MIN_LEN, MAVLINK_MSG_ID_MAGNETIC_FIELD_LEN, MAVLINK_MSG_ID_MAGNETIC_FIELD_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_magnetic_field_send_struct(mavlink_channel_t chan, const mavlink_magnetic_field_t* magnetic_field)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_magnetic_field_send(chan, magnetic_field->timestamp, magnetic_field->mag_x, magnetic_field->mag_y, magnetic_field->mag_z);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MAGNETIC_FIELD, (const char *)magnetic_field, MAVLINK_MSG_ID_MAGNETIC_FIELD_MIN_LEN, MAVLINK_MSG_ID_MAGNETIC_FIELD_LEN, MAVLINK_MSG_ID_MAGNETIC_FIELD_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_MAGNETIC_FIELD_LEN? msg->len : MAVLINK_MSG_ID_MAGNETIC_FIELD_LEN;
        memset(magnetic_field, 0, MAVLINK_MSG_ID_MAGNETIC_FIELD_LEN);
    memcpy(magnetic_field, _MAV_PAYLOAD(msg), len);
#endif
}
